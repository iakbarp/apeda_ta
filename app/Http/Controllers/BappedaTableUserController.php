...
class BappedaTableUserController extends Controller
{
...
//                $object['due'] = Carbon::createFromFormat('Y-m-d H:i:s', $key->created_at)->formatLocalized('%A, %d %B %Y');
    ...
    public function storesuratplus(Request $r)
    {
        ...
        Mail::send('bappeda.pengurus.mail.send', $data, function ($message) use ($data) {
    ...
    {
        return view('bappeda.pengurus.mail.send');
    }
