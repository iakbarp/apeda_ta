            ...
            <div class="row">
                ...
                <section class="col-lg-7 connectedSortable">
                    ...
                    <div class="box box-warning">
                        ...
                        <div class="box-footer text-center">
                            <a href="{{route('usulan.index')}}" class="uppercase">Buat Berkas Surat Baru</a>
                        </div>
                        <!-- /.box-footer -->
                    </div>
                ...
                <section class="col-lg-5 connectedSortable">
                    ...
                    <div class="box box-danger">
                        ...
                        <div class="box-footer text-center">
                            <a href="{{route('bappeda.table.user')}}" class="uppercase">Lihat Semua Pengguna</a>
                        </div>
                        <!-- /.box-footer -->
                    </div>
                    <!--/.box -->
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-footer text-center" style="">
                            <a href="{{url('bappeda/table/letter')}}" class="uppercase">Lihat Semua Kategori Surat</a>
                        </div>
                        <!-- /.box-footer -->
                    </div>
...
//                    console.log($(id).data("id"));
                    $.ajax({
                        url: "{{route('bappeda.carouseldelete')}}",
                        type: "GET",
                        data: {'id': $(id).data("id")},
                        success: function (data) {
                            $("div#divLoading").addClass('hide');
        ...
        $(function () {
            $('#modal-form3 form').on('submit', function (e) {
                if (!e.isDefaultPrevented()) {
                    ...
                    $.ajax({
                        url: "{{route('bappeda.carouseledit')}}",
                        type: "post",
