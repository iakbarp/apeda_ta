...
<script>
    function changePenghuni(id) {
        ...
        if ($index2 == 0) {
            ...
            console.log('na');
            $.ajax({
                url: "{{route('user.desa.table.penghuni.histori')}}",
                type: "get",
                data: {
                    // 'id': $index2,
            ...
            $.ajax({
                url: "{{route('user.desa.table.penghuni.api')}}",
                type: "get",
                data: {
                    'id': $index2,
                    'pagination': pagination2[prefix2 + $index2],
...
<script>
    ...
    function lihatuser(asd) {
        ...
        $.ajax({
            url: "{{route('user.desa.table.pengguna.lihat')}}",
            type: "get",
            data: {'id': $id},
            success: function (data) {
                console.log(data);
...
<script>
    ...
    $('#modal-form').on('change', '#job_id', function (asd) {
        $.ajax({
            type: 'get',
            url: '{{route('user.desa.table.user.getPosisition')}}',
            data: {'id': $(this).val()},
            success: function (data) {
                if (!$.trim(data[0])) {
...
<script>
    function hapususer($id) {
        ...
        $('.content .row').css("opacity", 0.4);
        $.ajax({
            url: "{{route('user.desa.table.pengguna.cekhapus')}}",
            type: "get",
            data: {'id': $id},
            success: function (data) {
                ...
                swal({
                    ...
                    if (!$.trim(isConfirm.dismiss)) {
                        $.ajax({
                            url: "{{route('user.desa.table.pengguna.hapus')}}",
                            type: "get",
                            data: {'id': $id},
                            success: function (data) {
                                selectuser = [];
...
<script>
    $('#modal-form form').on('submit', function (e) {
        ...
        $.ajax({
            url: "{{route('user.desa.table.pengguna.edit')}}",
            type: "post",
...
<script>
    ...
    function send($x, entit) {
        $.ajax({
            url: "{{route('user.desa.table.pengguna.storesuratplus')}}",
            // async: false,
            type: "post",
...
<script>
    $('#data2').on('input', '.nik', function (asd) {
        ...
        $.ajax({
            url: "{{route('user.desa.table.pengguna.ceknik')}}",
            type: "get",
    ...
    function resendEmail($id) {
        ...
        if (navigator.onLine) {
            if ($id == 'na') {
                ...
                $.ajax({
                    url: "{{route('user.desa.table.pengguna.resend')}}",
                    type: "get",
                    data: {'id': $id},
                    success: function (data) {
                        $(':button').prop('disabled', false);
