...
class EmployesController extends Controller
{
    ...
    {
        $data = mst_data::where('category_id', 128)->orderBy('id', 'desc')->skip(41)->take(13)->get();
    ...
    public function caridata(Request $request)
    {
        ...
        if(!empty($data->cities)) {
            ...
            $cities="Data belum diisi";
        }
        $data1 = array('name' => $name, 'nip' => $data->nip, 'ttl' => $tgl, 'email' => $data->email, 'cities' => $cities, 'phone' => $phone, 'bio' => $bio,
