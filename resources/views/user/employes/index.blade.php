...
@section('title', 'Aplikasi Pembangunan Daerah | Daftar Pegawai')
@section('nav')
        ...
        <div class="container">
            <div class="row animate-box">
                <div class="col-md-8 col-md-offset-2 text-center fh5co-heading" style="margin-bottom: 3em">
                    <h2><i class="fa fa-history"></i>Daftar Kecamatan yang telah terdaftar</h2>
                </div>
            </div>
            <div class="row animate-box">
        ...
        function showForm(id) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    trHTML = '';
                    trHTML += '<tr><td width="100px">NIK</td><td>:</td><td>' + data.nik + '</td></tr>';
                    ...
                    if (!$.trim(data.category)) {
                        trHTML += '<tr><td width="60px">Seksi</td><td>:&nbsp;</td><td>' + data.job.name + ' ' + data.provinces.name + '</td></tr>';
                    }
                    else {
                        trHTML += '<tr><td width="60px">Jabatan</td><td>:&nbsp;</td><td>' + data.category.name + ' di ' + data.job.name + ' di ' + data.cities.name + '</td></tr>';
                    }
                    if (data.softdel==0) {
