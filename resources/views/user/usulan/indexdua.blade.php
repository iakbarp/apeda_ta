...
@section('title', 'Form Usulan Pembangunan Daerah')
@section('nav')
    <li><a href="{{url('home')}}">Home</a></li>
    <li><a href="{{url('profile')}}">Profil</a></li>
    <li><a href="{{url('employes')}}">Daftar Pegawai</a></li>
    <li class="active"><a href="{{url('FormUsulan#fh5co-form')}}">Form Usulan</a></li>
@endsection
@section('style')
    <style>
        select.disabled {
...
@section('script')
                            ...
                            if (data.status == 0) {
                                ...
                                swal({
                                    ...
                                    if (!$.trim(isConfirm.dismiss)) {
                                        $.ajax({
                                            url: "<?php echo e(route('usulan.delete')); ?>",
                                            type: "GET",
                        ...
                        success: function (data) {
                            if (data.status == 0) {
                                ...
                                swal({
                                    ...
                                    if (!$.trim(isConfirm.dismiss)) {
                                        $.ajax({
                                            url: "<?php echo e(route('usulan.restore')); ?>",
                                            type: "GET",
                                            data: {'id': $dataRestore},
                                            success: function (data) {
                                                console.log(data);
    ...
    <script>
        function historiData(e) {
            ...
            $idHistori = $(e).data('id');
            $.ajax({
                url: "<?php echo e(route('usulan.history')); ?>",
                type: "GET",
