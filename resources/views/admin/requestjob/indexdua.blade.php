...
@section('title', 'Aplikasi Perencanaan Pembangunan Daerah | Berkas Data')
@section('nav')
                                            ...
                                            <div class="col-lg-12">
                                                <table id="ulang">
                                                    ...
                                                    <textarea class="form-control" placeholder="Kota"
                                                        ...
                                                        <td>
                                                    <textarea class="form-control" placeholder="Kecamatan"
                                                              id="district_id"
...
@section('script')
    <script>
        ...
        $(document).ready(function () {
            var bias = 0;
            var url1 = [];
            url1.push("{{route('api2.mst.data3')}}");
            url1.push("{{route('api2.mst.data4')}}");
            ...
            $(document).on('change', '#jumlah', function () {
                ...
                $.ajax({
                    type: 'get',
                    url: '{!!URL::to('admin.request/jumlah')!!}',
                        ...
                        success: function (data) {
                            ...
                            if (data.status == 0) {
                                ...
                                swal({
                                    ...
                                    if (!$.trim(isConfirm.dismiss)) {
                                        $.ajax({
                                            url: "{{route('admin.request.restore')}}",
                                            type: "GET",
                                            data: {'id': $(id).data("id")},
                                            success: function (data) {
//                        console.log(data);
        ...
        function deletePermData(id) {
            swal({
                ...
                if (!$.trim(isConfirm.dismiss)) {
                    $.ajax({
                        url: "{{route('admin.request.deleteperm')}}",
                        type: "GET",
                        data: {'id': $(id).data("id")},
                        success: function (data) {
//                            console.log(data);
...
//                            console.log(jd2);
        ...
        function historyData(id) {
            ...
            $.ajax({
                type: 'get',
                url: '{{route('admin.request.history')}}',
                data: {'id': id},
                success: function (data) {
//                    console.log('data');
                    tanggal = '';
