        ...
        <div class="top-menu">
            <div class="container">
                <div class="row">
                    <div class="col-xs-1">
                        <div id="fh5co-logo">
                            <a href="{{route('dashboard')}}">A<span>.</span>P<span>.</span>E<span>.</span>D<span>.</span>A<span>.</span>
                            </a>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row row-pb-md">
                <div class="col-md-3 fh5co-widget">
                    <h4 style="text-transform: uppercase"><span style="color: #0b93d5"> A.P.E.D.A</span></h4>
                    <p style="text-transform: uppercase">"<span style="color: #0b93d5 ">A</span>PLIKASI,
                        <span style="color: #0b93d5 ">PE</span>MBANGUNAN, <span style="color: #0b93d5 ">DA</span>ERAH"</p>
                </div>
            ...
            <div class="row copyright">
                <div class="col-md-12 text-center">
                    <p>
                        <small class="block">Copyright &copy; 2018 APEDA. All Rights Reserved.</small>
                        <small class="block"><p style="color: #0b93d5"> Designed by MAP Production
                                                 System by Muhammad Akbar Priambodo</p>
                        </small>
                    </p>
                    <p>
                    <ul class="fh5co-social-icons">
                        <li>
                            <a href="https://www.facebook.com/akbar.talun/"><i class="icon-facebook"></i></a>
                        </li>
                        <li><a href="https://twitter.com/iakbarp"><i class="icon-twitter"></i></a></li>
                        <li>
                            <a href="https://www.instagram.com/akbarpriambodo_/"><i class="icon-instagram"></i></a>
                        </li>
                        <li>
