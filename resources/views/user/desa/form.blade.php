                ...
                <div class="modal-body" id="content">
                    <div class="container-fluid">
                        <div class="row form-group has-feedback">
                            <div class="col-md-6">
                                <input placeholder="Nama lengkap" data-toggle="tooltip" title="ukuran 1280 x 720 px"
                                       id="img" type="file"
                                       class="form-control"
                                       name="img"
                                       required autofocus>
                        ...
                        <div class="row form-group has-feedback">
                            ...
                            <div class="col-md-6">
                                <input placeholder="Isi Tombol" id="button" type="text"
                                       ...
                                       name="button"
                                       required autofocus>
                                <span data-toggle="tooltip" title="{{url('').'/'}}"><input type="checkbox" value="1"
        ...
        <div class="modal-content">
            <form method="post" class="form-horizontal">
                    ...
                    <div class="container-fluid">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="avatar-upload">
                                    <div class="avatar-edit" id="editimgca">
                                        ...
                                        <label for="imageUpload" data-toggle="tooltip"
                                               title="klik untuk ganti gambar"></label>
                                    </div>
                        ...
                        <div class="row form-group has-feedback">
                            <div class="col-md-12">
                                ...
                                <span data-toggle="tooltip" title="{{url('').'/'}}" id="domainload"><input
                                            type="checkbox" class="content1" value="1" id="domain" name="domain">
                                    <em>Masuk Domain ini?</em>
                                </span>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger" id="klik3" data-id="0" onclick="deleteSlide(this)">
                        Hapus
                    </button>
                    <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                </div>
