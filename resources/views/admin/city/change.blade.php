    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{route('admin.city.change', Auth::user()->city_id)}}">Kota/Kabupaten</a></li>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            <form action="{{ route('admin.city.update', $city->id) }}" class="" method="POST"
                                ...
                                <div class="container-fluid">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            ...
                                            @foreach ($provinces as $key => $value)
                                                <input value="{{$value->id}}"
                                                       {{ $value->id == $city->province_id ? 'selected' : ''}} type="hidden">
                                            @endforeach
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            <textarea name="description" class="form-control" cols="30" rows="5"
                                                      placeholder="Deskripsi">{{$city->description}}</textarea>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            <textarea name="vision" class="form-control" cols="30" rows="5"
                                                      placeholder="Visi">{{$city->vision}}</textarea>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            <textarea name="mision" class="form-control" cols="30" rows="5"
                                                      placeholder="Misi">{{$city->mision}}</textarea>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            <input type="text" name="youtube" class="form-control"
                                                   placeholder="Youtube Video ID" value="{{$city->youtube}}">
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            <img src="{{ asset('storage/' . $city->photo) }}" alt=""
                                    ...
                                    <div class="row form-group">
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            ...
                                            {{-- <a class="btn btn-danger btn-md" href="{{ route('admin.city.delete', $city->id) }}" onclick="return confirm('Hapus data?')">Hapus</a> --}}
                                            <button type="submit" class="btn btn-primary btn-md"
                                                    onclick="return confirm('Ubah data?')">Simpan
                                            </button>
                                        </div>
                                    </div>
                                </div>
