                                                ...
                                                <tr>
                                                    ...
                                                    <td align="justify">
                                                        <div id="jabatan">
                                                            ...
                                                            @else
                                                                {{\App\trDataPosisition::findOrFail($user->posisition_id)->name.' di '.\App\city::findOrFail($user->city_id)->name}}
                                                                @if($ganti==1)
...
//                var div = $(this).parent();
        ...
        $('#semua').click(function () {
            ...
            if ($("#ava").val() != '' || $("#name").val() != '' || $("#tempat_lahir").val() != '' || $("#tgl_lahir").val() != ''
                || $("#phone").val() != '' || $("#bio").val() != '' || $("#city_id").val() != '' || $("#email").val() != '' || $("#posisition_id").val() != ''
                || $("#city_id").val() != '') {
