...
class GeneralController extends Controller
{
    ...
    public function index()
    {
        ...
        foreach (Datacarousel::all() as $row) {
            ...
            $carousel[] = array('title' => $row->title,
                'desc' => $row->desc, 'button' => $row->button, 'img' => $row->img, 'url' => $url);
        }
//        dd($carousel);
        return view('user.dashboard', compact('jumlah', 'jobdesc', 'carousel', 'user'));
    }
