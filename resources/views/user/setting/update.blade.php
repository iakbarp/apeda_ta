...
@section('title', 'APEDA | '.\Illuminate\Support\Facades\Auth::user()->name.'`s Profile')
@section('nav')
                            ...
                            <div class="w3-panel w3-card">
                                ...
                                <div style="padding-top: 2%" class="col-lg-12 text-center">
                                    ...
                                    <span class="help-block">
                                        ...
                                        <strong id="update"> {{$user->updated_at->diffForHumans()}}</strong>
                                    </span>
                                    ...
                                    >
                                        ...
                                        <div class="col-lg-6" style="padding-top: 2%;padding-left: 5%">
                                            <table>
                                                ...
                                                <td valign="baseline" align="left" width="80px"><b>NIK</b></td>
                                                <td valign="top">:&nbsp;&nbsp;</td>
                                                <td align="justify">
                                                    <div id="nik">{{$user->nik}}</div>
                                                </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="justify">
                                                        ...
                                                        <input placeholder="Tanggal Lahir" type="text"
                                                               ...
                                                               value="@if($user->tgl_lahir!=null){{$user->tgl_lahir}}@endif"
                                                        ></td>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="justify">
                                                        <div id="jabatan">
                                                            ...
                                                            @else
                                                                {{\App\trDataJobDesc::findOrFail($user->job_id)->name.' di '.\App\trDataPosisition::findOrFail($user->posisition_id)->name}}
                                                                @if($ganti==1)
                                            ...
                                            <br>
                                            <br>
                                            <h6 style="font-size: small">*Klik dua kali pada bagian yang ingin diubah. serta klik di bagian luar untuk menyimpan</h6>
                                            <br>
                                            <br>
                                            <br>
...
//                            $('#jabatan').append(data.jabatan);
        ...
        $("#email2").dblclick(function () {
            ...
            swal({
                title: 'Peringatan!',
                text: 'Demi keamanan dan Kenyamanan, Email tidak dapat diubah!.',
                type: 'error',
                timer: '1500'
            })
        });
        ...
        $("#jabatan").dblclick(function () {
            ...
            swal({
                title: 'Peringatan!',
                text: 'Demi keamanan dan Kenyamanan, Jabatan tidak bisa dirubah!.',
                type: 'error',
                timer: '1500'
            })
        ...
        $("#nik").dblclick(function () {
            swal({
                title: 'Peringatan!',
                text: 'NIK tidak bisa dirubah!',
                type: 'error',
                timer: '1500'
            })
        });
...
{{--@extends('layouts.user.mst_user_relog')--}}
{{--@section('title', 'APEDA | '.\App\city::findOrFail($user->city_id)->name.'`s Profile')--}}
{{--@section('nav')--}}
    {{--<li><a href="{{url('home')}}">Home</a></li>--}}
                                            ...
                                            {{--<table>--}}
                                                ...
                                                {{--<tr>--}}
                                                    ...
                                                    {{--<td align="justify">--}}
                                                        {{--<div id="jabatan">--}}
                                                            {{--@if(is_null($user->job_id))--}}
                                                                {{--{{\App\district::findOrFail($user->district_id)->name}}--}}
                                                                {{--@elseif(is_null($user->job_id))--}}
                                                                    {{--{{\App\city::findOrFail($user->city_id)->name}}--}}
                                                            {{--@elseif ($user->role_id==3)--}}
                                                                {{--{{\App\trDataJobDesc::findOrFail($user->job_id)->name.' di Kecamatan '.\App\district::findOrFail($user->district_id)->name}}--}}
                                                            {{--@elseif ($user->role_id==2)--}}
                                                                {{--{{\App\trDataJobDesc::findOrFail($user->job_id)->name.' di '.\App\city::findOrFail($user->city_id)->name}}--}}
                                                                {{--@if($ganti==1)--}}
                                                                    {{--<em title="menunggu perubahan ke..."> ({{$ke}})</em>--}}
                                                                {{--@endif--}}
                                                            {{--@endif--}}
                                                        ...
                                                        {{--<select name="district_id" id="district_id"--}}
                                                            ...
                                                            {{--@foreach(app\district::where('city_id',Auth::user()->city_id)->get() as $row)--}}
                                                                {{--<option value="{{$row->id}}"--}}
                                                                        {{--@if ($row->id==$user->district_id)--}}
                                                                        {{--selected--}}
                                                                        {{--@endif>{{$row->name}}</option>--}}
                                                            {{--@endforeach--}}
                                                        {{--</select>--}}
                                                        ...
                                                        {{--@if ($user->role_id==2)--}}
                                                            {{--<select name="city_id" id="city_id"--}}
                                                                ...
                                                                {{--@foreach(app\city::where('city_id',Auth::user()->city_id)->get() as $row)--}}
                                                                    {{--<option value="{{$row->id}}"--}}
                                                        ...
                                                        {{--@endif--}}
                                                            ...
                                                            {{--@foreach($category as $row)--}}
                                                            {{--<input id="job_id" type="hidden" class="form-control" name="job_id" value="{{$row->id}}--}}
                                                            {{--@if ($row->id==$user->job_id)--}}
                                                                    {{--selected--}}
                                                                    {{--@endif" readonly>--}}
                                                            {{--@endforeach--}}
...
{{--@section('script')--}}
    {{--<script>--}}
        ...
        {{--$(document).ready(function () {--}}
            ...
            {{--$(document).on('change', '#district_id', '#city_id', function () {--}}
...
{{--//                var div = $(this).parent();--}}
        ...
        {{--$('#semua').click(function () {--}}
            ...
            {{--console.log(a);--}}
            {{--if ($("#ava").val() != '' || $("#name").val() != '' || $("#tempat_lahir").val() != '' || $("#tgl_lahir").val() != ''--}}
                {{--|| $("#phone").val() != '' || $("#bio").val() != '' || $("#district_id").val() != '' || $("#email").val() != '' || $("#job_id").val() != ''--}}
                {{--|| $("#city_id").val() != '' )  {--}}
...
{{--//                            $('#jabatan').append(data.jabatan);--}}
                                            {{--$('#alamat2').append(data.alamat);--}}
                                            {{--$('#bio2').empty().append(data.bio);--}}
                                            {{--$('#district_id2').empty().append(data.district_id);--}}
                                            {{--$('#city_id2').empty().append(data.city_id);--}}
                                            {{--$('#semua form .data2').hide();--}}
                                            {{--$('#semua form :input').prop('readonly', false);--}}
                                            {{--$('#semua form .data2').val('');--}}
                                            {{--$('#semua form .data2').empty();--}}
                                            ...
                                            {{--$('#bio').val(data.bio);--}}
                                            {{--for (var i = 0; i < data.job.length; i++) {--}}
                                                {{--if (data.district_id == data.job[i].id) {--}}
                                                    {{--sel.push('selected');--}}
                                                {{--}--}}
                                                {{--else {--}}
                                                    {{--sel.push('');--}}
                                            ...
                                            {{--op2 += '<option value="" selected disabled>Pilih Posisi Seksi</option>\n';--}}
                                            {{--for (var i = 0; i < data.job.length; i++) {--}}
                                                {{--op2 += '<option value="' + data.job[i].id + '" ' + sel2[i] + '>' + data.job[i].name + '</option>\n';--}}
                                            {{--}--}}
                                            {{--if (data.status == 1) {--}}
                                                {{--$('#jabatan').append('<em title="menunggu pergantiaan"> (ke ' + data.jabatan + ')</em>');--}}
                                                {{--data2 = data.status;--}}
        ...
        {{--$("#bio2").dblclick(function () {--}}
            ...
            {{--$('#bio').focus();--}}
        {{--});--}}
        {{--$("#district_id2").dblclick(function () {--}}
            {{--b = 1;--}}
            {{--a = 2;--}}
            {{--$('#district_id2').hide();--}}
            {{--$('#district_id').show();--}}
