                ...
                <div class="col-xs-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            ...
                            <button class="btn btn-primary acceptall" data-toggle="tooltip"
                                    title="Pilih data terlebih dahulu">Terima
                            </button>
                            <button class="btn btn-default denyall" data-toggle="tooltip"
                                    title="Pilih data terlebih dahulu">Tolak
                            </button>
                            {{--</div>--}}
